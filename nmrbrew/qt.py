...
if not ON_RTD:
    ...
    # Must be loaded after Qt but before the application is created
    import pyqtgraph

    # Create a Qt application
    app = QApplication(sys.argv)
    # app.setStyle('fusion')
    app.setOrganizationName("NMRBrew")
    app.setOrganizationDomain("nmrbrew.org")
    app.setApplicationName("NMRBrew")
