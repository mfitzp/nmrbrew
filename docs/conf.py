# -*- coding: utf-8 -*-
#
# NMRbrew documentation build configuration file, created by
...
latex_documents = [
  ('index', 'NMRbrew.tex', u'NMRbrew Documentation',
...
man_pages = [
    ('index', 'nmrbrew', u'NMRbrew Documentation',
...
texinfo_documents = [
  ('index', 'NMRbrew', u'NMRbrew Documentation',
   u'Martin A. Fitzpatrick, Catherine M. McGrath, Stephen P. Young', 'NMRbrew', 'One line description of project.',
   'Miscellaneous'),
]
