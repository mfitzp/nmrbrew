...
__version__ = open(os.path.join('nmrbrew','VERSION'),'rU').read()
print __version__
...
try:
    ...
    build_all['include_files']=[
        ...
        ('nmrbrew/database', 'database'),
        ('nmrbrew/plugins', 'plugins'),
        ('nmrbrew/demos', 'demos'),
        ('nmrbrew/identities', 'identities'),
        ('nmrbrew/html', 'html'),
        ('nmrbrew/icons', 'icons'),
        ]
    ...
    build_mac['iconfile'] = 'nmrbrew/static/icon.icns'
    base = None
    if sys.platform == "win32":
        base = "Win32GUI"
        build_exe['include_msvcr'] = True
        build_exe['icon'] = 'nmrbrew/static/icon.ico'
...
setup(
    ...
    url='https://github.com/nmrbrew/nmrbrew',
    download_url='https://github.com/nmrbrew/nmrbrew/zipball/master',
    description='Metabolic pathway visualisation and analysis.',
    long_description='NMRbrew is workflow-based scientific data processing, analysis and \
